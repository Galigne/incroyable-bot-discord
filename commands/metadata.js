const COMMAND_METADATA = [
	...
	},
	{
		...
		category: 'rpg',
		permission: 'dm',
		descriptionKey: 'rpg.genCreature.schemaDescription',
		options: [
			{
				name: 'creature-key',
				type: 'string',
				descriptionKey: 'rpg.genCreature.keyOption',
				required: true,
				minLength: 1,
				maxLength: 50,
			},
			{
				name: 'level',
				type: 'integer',
				descriptionKey: 'rpg.genCreature.levelOption',
				minValue: 1,
				maxValue: 10,
				autocomplete: {
					provider: 'static',
					values: Array.from({ length: 10 }, (_, index) => ({
						value: index + 1,
						nameKey: 'rpg.genCreature.levelChoice',
						nameVariables: { level: index + 1 },
					})),
				},
			},
			{
				name: 'type',
				type: 'string',
				descriptionKey: 'rpg.genCreature.typeOption',
				autocomplete: { provider: 'creature-types' },
			},
		],
		examples: [
		...
		help: {
			order: 22,
			summaryKey: 'rpg.genCreature.description',
			detailsKey: 'rpg.genCreature.behavior',
		},
		guildOnly: true,
		handler: './handlers/genCreature',
	},
	{
		id: 'roll',
		name: 'roll',
